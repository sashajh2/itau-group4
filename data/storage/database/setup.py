...
CREATE TABLE IF NOT EXISTS segments (
    ...
    audio_model TEXT DEFAULT NULL,       -- audio model used to generate synthetic audio. null if real
    video_model TEXT DEFAULT NULL,       -- video model used to generate synthetic video. null if real

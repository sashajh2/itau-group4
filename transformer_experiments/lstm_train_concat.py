...
def main():
    ...
    plot_training_curve(losses, os.path.join(results_dir, f"loss_concat_{timestamp}.png"))
    plot_confusion_matrices(train_cm, test_cm, os.path.join(results_dir, f"confusion_concat_{timestamp}.png"))

"""
Vanilla (unidirectional) LSTM classifier for deepfake detection on HuBERT sequences.
...
class VideoLSTMBaseline(nn.Module):
    """Unidirectional LSTM for binary sequence classification."""

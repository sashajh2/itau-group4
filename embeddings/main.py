...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to dataset DataFrame (e.g., .pkl)",
    )
    parser.add_argument(
        "--out_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["audio", "video", "forensic"],
        help="Embedding mode: audio, video, or forensic",
    )
